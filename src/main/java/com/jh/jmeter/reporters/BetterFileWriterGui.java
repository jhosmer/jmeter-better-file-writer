package com.jh.jmeter.reporters;
...
public class BetterFileWriterGui extends AbstractListenerGui implements ClipboardOwner {

	public static final String WIKIPAGE = "BetterFileWriter";
    ...
    public String getStaticLabel() {
        return "Better File Writer"; //  JMeterPluginsUtils.prefixLabel
    }
    ...
    public TestElement createTestElement() {
        TestElement te = new BetterFileWriter();
        modifyTestElement(te);
        te.setComment("Contact Jonathan Hosmer <jhosmer@happyfuncorp.com> for help with this plugin");
        return te;
    }
    ...
    public void modifyTestElement(TestElement te) {
        ...
        if (te instanceof BetterFileWriter) {
            BetterFileWriter fw = (BetterFileWriter) te;
    ...
    private void initFields() {
        filename.setText("testResults.jtl");
    ...
    public void configure(TestElement element) {
        ...
        BetterFileWriter fw = (BetterFileWriter) element;
    ...
    private void init() {
        ...
        addToPanel(mainPanel, labelConstraints, 0, 2, new JLabel("Overwrite: ", JLabel.RIGHT));
        addToPanel(mainPanel, editConstraints, 1, 2, overwrite = new JCheckBox());

        addToPanel(mainPanel, labelConstraints, 0, 3, new JLabel("File Header: ", JLabel.RIGHT));
        ...
        addToPanel(mainPanel, labelConstraints, 0, 4, new JLabel("Sample line format: ", JLabel.RIGHT));
        addToPanel(mainPanel, editConstraints, 1, 4, columns = new JTextField(20));

        editConstraints.insets = new java.awt.Insets(2, 0, 0, 0);
        labelConstraints.insets = new java.awt.Insets(2, 0, 0, 0);
        addToPanel(mainPanel, labelConstraints, 0, 5, new JLabel("File Footer: ", JLabel.RIGHT));
    ...
    private JPanel createHelperPanel() {
        ...
        ret.add(new JLabel("Available sample fields (click to copy the field name to clipboard):"), labelConstraints);
    ...
    private class CopyAction implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            clipboard.setContents(transferable, BetterFileWriterGui.this);
        }
    }
}
